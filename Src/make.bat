...
set PARSER_SRCS=parser/parser.cpp parser/statement_parser.cpp parser/expression_parser.cpp
set SRC_FILES=*.cpp lexer/*.cpp utilities/*.cpp types/*.cpp runtime_dll/*.cpp abstx/*.cpp %PARSER_SRCS%
